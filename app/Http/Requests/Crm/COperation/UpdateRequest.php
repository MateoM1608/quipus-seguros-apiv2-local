...
class UpdateRequest extends BaseFormRequest
{
    ...
    {
        return [
            'operation_name' => $this->has('operation_name') ? [
                "required" 
            ] : [],
            'operation_description' => $this->has('operation_description') ?[
                "required" 
            ] : [],
            'start_date' => $this->has('start_date') ?[
                "required",
                "date" 
            ] : [],
            ...
            'c_operation_type_id' => $this->has('c_operation_type_id') ?[
                "required" ,
                "numeric"
            ] : []
        ];
