...
class SClient extends Model
{
    ...
    protected $fillable = [
        'identification','first_name', 'last_name', 'birthday', 'adress', 'fix_phone', 'cel_phone', 'email', 'g_city_id', 'g_identification_type_id', 'observations', 'habeas_data_terms', 'habeas_data_email','habeas_data_sms','habeas_data_phone'
    ];
