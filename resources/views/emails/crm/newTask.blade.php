                                    ...
                                    <tr>
                                        <td valign="top" style="padding:48px 48px 32px">
                                            <div style="color:#636363;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left">
                                                <p style="margin:0 0 16px">Hola. Se ha creado una nueva tarea para el caso de CRM con # <a href="{{ $url }}/crm/cases/{{ $case }}">{{ $case }}</a> y se te ha asignado como responsable. Para ver mas detalles da clic <a href="{{ $url }}/crm/cases/{{ $case }}">aquí</a>.</p>
